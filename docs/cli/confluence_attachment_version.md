...
Show one attachment version

## Synopsis

Show one version record for one attachment.
...
confluence attachment version 12345 2
  confluence attachment version 12345 2 --json

## Usage

```text
confluence attachment version <id> <number>
```
