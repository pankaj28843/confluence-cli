# confluence smart-link children

List direct children of a Cloud smart link

## Synopsis

List direct children of one Cloud smart link.
...
confluence smart-link children 12345
  confluence smart-link children 12345 --type page --type database --json
  confluence smart-link children 12345 --sort position --limit 100

## Usage

```text
confluence smart-link children <id> [flags]
```
